            ...
            <Card className="w-full max-w-3xl overflow-hidden shadow-lg">
                <CardContent className="grid p-0 md:grid-cols-2">
                    ...
                    <div className="relative hidden min-h-[420px] md:block">
                        <img src="https://i.pinimg.com/736x/21/9b/16/219b16b0bbc6a9b9bbf1ca3b8c80f03a.jpg" alt="Image" className="absolute inset-0 h-full w-full object-cover dark:brightness-[0.2] dark:grayscale" />
                    </div>
                </CardContent>
            </Card>
        </div>
